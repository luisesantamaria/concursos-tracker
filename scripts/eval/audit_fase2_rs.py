...
def ai_verdict(session, model: str, municipio: str, bucket: str,
    ...
    prompt = (
        ...
        "Definições:\n"
        "- valido_indice: mostra ESTRUTURA inequívoca e estável de listagem "
        "(filtros, tabela/cards, paginação, categoria ou endpoint), mesmo com 0 ou "
        "1 resultado visível. NÃO exija múltiplos resultados. "
        ...
        "- nao_e_indice: detalhe de edital único com anexos, notícia, PDF ou "
        "menu sem estrutura de listagem. Uma lista vazia com estrutura inequívoca "
        "continua sendo índice.\n"
        "- licitacao_ou_cultural: licitação/pregão ou concurso cultural (soberana/rainha).\n\n"
        "IMPORTANTE: classifique pelo CONTEÚDO real, não pelo título ou slug. "
        "NÃO invente nem confirme autoridade/identidade. "
