...
- **2b ✅ Motor V2 de adjudicación (AI-first)**: certificador A con citas
  ...
  idéntica V2 22/23 vs V1 2/23.**
- **2c 🔄 Cierre RS** (pasos F2.P1-P8 del PLAN_MAESTRO): fixes mecánicos de
  evidencia → política de índice → fixture envenenado (mide al fiscal B) →
  R4 ≥30/36 → adjudicación humana → **holdout ciego de 50** → sonda de cuota
  → corrida de los 497 con auditoría muestral.
