...
The golden set (`data/golden_set_v1.csv`) contains 24 municipalities verified by hand with the correct URLs. It is the **independent ground truth** — never generated by the pipeline.
