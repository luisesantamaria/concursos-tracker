...
24 municipalities verified by hand (`authority_first/data/golden_set_v1.csv`)
...
authority_first/data/         Golden set, registries.
authority_first/docs/         Manuals, architecture, roadmap, runbook.
staging/fase2_v2/eval/        Frozen evaluation runs + fixtures (gitignored).
laboratorio/                  Historical experiments.
```
...
.venv/bin/python -m scripts.fase2_municipios.v2.eval.semantic_comparison \
  --run-dir staging/fase2_v2/eval/<RUN> --golden authority_first/data/golden_set_v1.csv \
  --output-dir staging/fase2_v2/eval/<NEW>

# Legacy golden evaluator (V1 CSV outputs)
python scripts/eval/medir_golden_set.py --golden authority_first/data/golden_set_v1.csv \
